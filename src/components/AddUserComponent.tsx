...
// src/components/AddUserComponent.tsx
...
const AddUserComponent = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center">
      <div className="w-screen md:w-[50%] h-full md:h-[60%] md:m-10 md:p-10 mt-5 md:mt-0">
        <form
        ...
        >
          ...
          {/* <button
            type="submit"
            className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition duration-200"
          >
            Add User
          </button> */}
          <button
